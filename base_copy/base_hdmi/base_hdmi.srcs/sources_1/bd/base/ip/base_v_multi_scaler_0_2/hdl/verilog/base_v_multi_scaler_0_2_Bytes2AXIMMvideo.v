...
module base_v_multi_scaler_0_2_Bytes2AXIMMvideo (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
        ...
        dstImgBuf0_V_offset_dout,
        dstImgBuf0_V_offset_empty_n,
        dstImgBuf0_V_offset_read,
        Height,
        mul_ln859_loc_c32_dout,
        mul_ln859_loc_c32_empty_n,
        mul_ln859_loc_c32_read,
        StrideInBytes
);
...
input  [27:0] dstImgBuf0_V_offset_dout;
input   dstImgBuf0_V_offset_empty_n;
output   dstImgBuf0_V_offset_read;
input  [15:0] Height;
input  [15:0] mul_ln859_loc_c32_dout;
input   mul_ln859_loc_c32_empty_n;
output   mul_ln859_loc_c32_read;
...
reg dstImgBuf0_V_offset_read;
reg mul_ln859_loc_c32_read;
...
reg   [0:0] icmp_ln1081_reg_317;
reg    dstImg_V_blk_n_AW;
wire    ap_CS_fsm_state3;
reg    dstImg_V_blk_n_W;
reg    ap_enable_reg_pp0_iter2;
reg   [0:0] icmp_ln1081_reg_317_pp0_iter1_reg;
reg    dstImg_V_blk_n_B;
wire    ap_CS_fsm_state110;
reg    dstImgBuf0_V_offset_blk_n;
reg    mul_ln859_loc_c32_blk_n;
reg   [12:0] x_0_i_i_i_i_reg_174;
reg    ap_block_state1;
wire   [12:0] trunc_ln_i_i_fu_195_p4;
reg   [12:0] trunc_ln_i_i_reg_278;
wire   [27:0] zext_ln1087_fu_215_p1;
reg   [27:0] zext_ln1087_reg_283;
wire   [31:0] empty_fu_219_p1;
reg   [31:0] empty_reg_288;
wire   [28:0] zext_ln1077_fu_223_p1;
reg   [28:0] zext_ln1077_reg_293;
wire   [15:0] y_fu_232_p2;
reg   [15:0] y_reg_301;
wire    ap_CS_fsm_state2;
wire   [28:0] add_ln321_fu_242_p2;
reg   [28:0] add_ln321_reg_306;
wire   [0:0] icmp_ln1077_fu_227_p2;
wire   [0:0] icmp_ln1081_fu_257_p2;
wire    ap_block_state4_pp0_stage0_iter0;
reg    ap_block_state5_pp0_stage0_iter1;
wire    ap_block_state6_pp0_stage0_iter2;
reg    ap_block_state6_io;
reg    ap_block_pp0_stage0_11001;
wire   [12:0] x_fu_262_p2;
reg    ap_enable_reg_pp0_iter0;
reg   [127:0] tmp_V_reg_326;
wire   [27:0] yoffset_fu_268_p2;
reg   [27:0] yoffset_reg_331;
wire    ap_CS_fsm_state7;
reg    ap_block_pp0_stage0_subdone;
reg    ap_condition_pp0_exit_iter0_state4;
reg   [27:0] yoffset_0_i_i_i_i_reg_151;
reg   [15:0] y_0_i_i_i_i_reg_163;
wire   [63:0] zext_ln321_1_fu_247_p1;
reg    ap_block_pp0_stage0_01001;
wire   [16:0] zext_ln1071_fu_185_p1;
wire   [16:0] add_ln1071_fu_189_p2;
wire   [11:0] lshr_ln_i_i_fu_205_p4;
wire   [28:0] zext_ln321_fu_238_p1;
reg   [107:0] ap_NS_fsm;
reg    ap_idle_pp0;
wire    ap_enable_pp0;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((icmp_ln1077_fu_227_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln1081_fu_257_p2 == 1'd0))) begin
        x_0_i_i_i_i_reg_174 <= x_fu_262_p2;
    end else if (((1'b1 == ap_CS_fsm_state3) & (m_axi_dstImg_V_AWREADY == 1'b1))) begin
        x_0_i_i_i_i_reg_174 <= 13'd0;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state110) & (m_axi_dstImg_V_BVALID == 1'b1))) begin
        y_0_i_i_i_i_reg_163 <= y_reg_301;
    end else if ((~((mul_ln859_loc_c32_empty_n == 1'b0) | (dstImgBuf0_V_offset_empty_n == 1'b0) | (ap_start == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        y_0_i_i_i_i_reg_163 <= 16'd0;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state110) & (m_axi_dstImg_V_BVALID == 1'b1))) begin
        yoffset_0_i_i_i_i_reg_151 <= yoffset_reg_331;
    end else if ((~((mul_ln859_loc_c32_empty_n == 1'b0) | (dstImgBuf0_V_offset_empty_n == 1'b0) | (ap_start == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        yoffset_0_i_i_i_i_reg_151 <= 28'd0;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state2) & (icmp_ln1077_fu_227_p2 == 1'd0))) begin
        add_ln321_reg_306 <= add_ln321_fu_242_p2;
    end
end

always @ (posedge ap_clk) begin
    if ((~((mul_ln859_loc_c32_empty_n == 1'b0) | (dstImgBuf0_V_offset_empty_n == 1'b0) | (ap_start == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        empty_reg_288[12 : 0] <= empty_fu_219_p1[12 : 0];
        trunc_ln_i_i_reg_278 <= {{add_ln1071_fu_189_p2[16:4]}};
        zext_ln1077_reg_293[27 : 0] <= zext_ln1077_fu_223_p1[27 : 0];
        zext_ln1087_reg_283[11 : 0] <= zext_ln1087_fu_215_p1[11 : 0];
    end
end

always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        icmp_ln1081_reg_317 <= icmp_ln1081_fu_257_p2;
        icmp_ln1081_reg_317_pp0_iter1_reg <= icmp_ln1081_reg_317;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln1081_reg_317 == 1'd0))) begin
        tmp_V_reg_326 <= bytes_plane0_V_V_dout;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state2)) begin
        y_reg_301 <= y_fu_232_p2;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state7)) begin
        yoffset_reg_331 <= yoffset_fu_268_p2;
    end
end

always @ (*) begin
    if ((icmp_ln1081_fu_257_p2 == 1'd1)) begin
...
always @ (*) begin
    if (((icmp_ln1077_fu_227_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln1081_reg_317 == 1'd0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln1081_reg_317 == 1'd0))) begin
...
always @ (*) begin
    if ((~((ap_start == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        dstImgBuf0_V_offset_blk_n = dstImgBuf0_V_offset_empty_n;
    end else begin
        dstImgBuf0_V_offset_blk_n = 1'b1;
    end
end

always @ (*) begin
    if ((~((mul_ln859_loc_c32_empty_n == 1'b0) | (dstImgBuf0_V_offset_empty_n == 1'b0) | (ap_start == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        dstImgBuf0_V_offset_read = 1'b1;
    end else begin
        dstImgBuf0_V_offset_read = 1'b0;
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (icmp_ln1081_reg_317_pp0_iter1_reg == 1'd0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter2 == 1'b1) & (icmp_ln1081_reg_317_pp0_iter1_reg == 1'd0))) begin
...
always @ (*) begin
    if ((~((ap_start == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        mul_ln859_loc_c32_blk_n = mul_ln859_loc_c32_empty_n;
    end else begin
        mul_ln859_loc_c32_blk_n = 1'b1;
    end
end

always @ (*) begin
    if ((~((mul_ln859_loc_c32_empty_n == 1'b0) | (dstImgBuf0_V_offset_empty_n == 1'b0) | (ap_start == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        mul_ln859_loc_c32_read = 1'b1;
    end else begin
        mul_ln859_loc_c32_read = 1'b0;
    end
end
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if ((~((1'b0 == ap_block_pp0_stage0_subdone) & (icmp_ln1081_fu_257_p2 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1)) & ~((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1)))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if ((((1'b0 == ap_block_pp0_stage0_subdone) & (icmp_ln1081_fu_257_p2 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1)) | ((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1)))) begin
...
assign add_ln1071_fu_189_p2 = (zext_ln1071_fu_185_p1 + 17'd15);

assign add_ln321_fu_242_p2 = (zext_ln1077_reg_293 + zext_ln321_fu_238_p1);
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((bytes_plane0_V_V_empty_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (icmp_ln1081_reg_317 == 1'd0));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_block_state6_io)) | ((bytes_plane0_V_V_empty_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (icmp_ln1081_reg_317 == 1'd0)));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((ap_enable_reg_pp0_iter2 == 1'b1) & (1'b1 == ap_block_state6_io)) | ((bytes_plane0_V_V_empty_n == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (icmp_ln1081_reg_317 == 1'd0)));
end

always @ (*) begin
    ap_block_state1 = ((mul_ln859_loc_c32_empty_n == 1'b0) | (dstImgBuf0_V_offset_empty_n == 1'b0) | (ap_start == 1'b0) | (ap_done_reg == 1'b1));
end

assign ap_block_state4_pp0_stage0_iter0 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state5_pp0_stage0_iter1 = ((bytes_plane0_V_V_empty_n == 1'b0) & (icmp_ln1081_reg_317 == 1'd0));
end

always @ (*) begin
    ap_block_state6_io = ((m_axi_dstImg_V_WREADY == 1'b0) & (icmp_ln1081_reg_317_pp0_iter1_reg == 1'd0));
end
...
assign empty_fu_219_p1 = trunc_ln_i_i_fu_195_p4;

assign icmp_ln1077_fu_227_p2 = ((y_0_i_i_i_i_reg_163 == Height) ? 1'b1 : 1'b0);

assign icmp_ln1081_fu_257_p2 = ((x_0_i_i_i_i_reg_174 == trunc_ln_i_i_reg_278) ? 1'b1 : 1'b0);

assign lshr_ln_i_i_fu_205_p4 = {{StrideInBytes[15:4]}};
...
assign m_axi_dstImg_V_AWADDR = zext_ln321_1_fu_247_p1;
...
assign m_axi_dstImg_V_AWLEN = empty_reg_288;
...
assign m_axi_dstImg_V_WDATA = tmp_V_reg_326;
...
assign trunc_ln_i_i_fu_195_p4 = {{add_ln1071_fu_189_p2[16:4]}};

assign x_fu_262_p2 = (x_0_i_i_i_i_reg_174 + 13'd1);

assign y_fu_232_p2 = (y_0_i_i_i_i_reg_163 + 16'd1);

assign yoffset_fu_268_p2 = (zext_ln1087_reg_283 + yoffset_0_i_i_i_i_reg_151);

assign zext_ln1071_fu_185_p1 = mul_ln859_loc_c32_dout;

assign zext_ln1077_fu_223_p1 = dstImgBuf0_V_offset_dout;

assign zext_ln1087_fu_215_p1 = lshr_ln_i_i_fu_205_p4;

assign zext_ln321_1_fu_247_p1 = add_ln321_reg_306;

assign zext_ln321_fu_238_p1 = yoffset_0_i_i_i_i_reg_151;

always @ (posedge ap_clk) begin
    zext_ln1087_reg_283[27:12] <= 16'b0000000000000000;
    empty_reg_288[31:13] <= 19'b0000000000000000000;
    zext_ln1077_reg_293[28] <= 1'b0;
end

endmodule //base_v_multi_scaler_0_2_Bytes2AXIMMvideo
