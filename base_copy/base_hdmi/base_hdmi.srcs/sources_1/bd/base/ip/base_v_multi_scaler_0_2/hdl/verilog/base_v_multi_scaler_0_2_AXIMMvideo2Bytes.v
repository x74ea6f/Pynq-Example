...
module base_v_multi_scaler_0_2_AXIMMvideo2Bytes (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
        ...
        srcImgBuf0_V_offset_dout,
        srcImgBuf0_V_offset_empty_n,
        srcImgBuf0_V_offset_read,
        img_plane0_V_V_din,
        img_plane0_V_V_full_n,
        img_plane0_V_V_write,
        Height,
        mul_ln821_loc_c_dout,
        mul_ln821_loc_c_empty_n,
        mul_ln821_loc_c_read,
        StrideInBytes,
        mul_ln821_loc_c31_din,
        mul_ln821_loc_c31_full_n,
        mul_ln821_loc_c31_write
);
...
input  [27:0] srcImgBuf0_V_offset_dout;
input   srcImgBuf0_V_offset_empty_n;
output   srcImgBuf0_V_offset_read;
output  [127:0] img_plane0_V_V_din;
input   img_plane0_V_V_full_n;
output   img_plane0_V_V_write;
input  [15:0] Height;
input  [15:0] mul_ln821_loc_c_dout;
input   mul_ln821_loc_c_empty_n;
output   mul_ln821_loc_c_read;
input  [15:0] StrideInBytes;
output  [15:0] mul_ln821_loc_c31_din;
input   mul_ln821_loc_c31_full_n;
output   mul_ln821_loc_c31_write;
...
reg srcImgBuf0_V_offset_read;
reg img_plane0_V_V_write;
reg mul_ln821_loc_c_read;
reg mul_ln821_loc_c31_write;
...
reg   [0:0] icmp_ln29_reg_322;
reg    srcImgBuf0_V_offset_blk_n;
reg    img_plane0_V_V_blk_n;
reg    ap_enable_reg_pp0_iter2;
reg   [0:0] icmp_ln29_reg_322_pp0_iter1_reg;
reg    mul_ln821_loc_c_blk_n;
reg    mul_ln821_loc_c31_blk_n;
reg   [12:0] x_0_i_i_i_i_reg_179;
reg    ap_block_state1;
wire   [12:0] trunc_ln_i_i_fu_200_p4;
reg   [12:0] trunc_ln_i_i_reg_283;
wire   [27:0] zext_ln37_fu_220_p1;
reg   [27:0] zext_ln37_reg_288;
wire   [31:0] empty_fu_224_p1;
reg   [31:0] empty_reg_293;
wire   [28:0] zext_ln24_fu_228_p1;
reg   [28:0] zext_ln24_reg_298;
wire   [15:0] y_fu_237_p2;
reg   [15:0] y_reg_306;
wire    ap_CS_fsm_state2;
wire   [28:0] add_ln33_fu_247_p2;
reg   [28:0] add_ln33_reg_311;
...
wire   [12:0] x_fu_267_p2;
reg    ap_enable_reg_pp0_iter0;
reg   [127:0] fb_pix_V_reg_331;
wire   [27:0] offset_fu_273_p2;
wire    ap_CS_fsm_state112;
wire    ap_CS_fsm_state108;
reg    ap_block_pp0_stage0_subdone;
reg    ap_condition_pp0_exit_iter0_state109;
reg   [27:0] offset_0_i_i_i_i_reg_156;
reg   [15:0] y_0_i_i_i_i_reg_168;
wire   [63:0] zext_ln33_1_fu_252_p1;
reg    ap_block_pp0_stage0_01001;
wire   [16:0] zext_ln29_fu_190_p1;
wire   [16:0] add_ln29_fu_194_p2;
wire   [11:0] lshr_ln_i_i_fu_210_p4;
wire   [28:0] zext_ln33_fu_243_p1;
reg   [109:0] ap_NS_fsm;
reg    ap_idle_pp0;
wire    ap_enable_pp0;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((icmp_ln24_fu_232_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state112)) begin
        offset_0_i_i_i_i_reg_156 <= offset_fu_273_p2;
    end else if ((~((mul_ln821_loc_c31_full_n == 1'b0) | (mul_ln821_loc_c_empty_n == 1'b0) | (srcImgBuf0_V_offset_empty_n == 1'b0) | (ap_start == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        offset_0_i_i_i_i_reg_156 <= 28'd0;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln29_fu_262_p2 == 1'd0))) begin
        x_0_i_i_i_i_reg_179 <= x_fu_267_p2;
    end else if ((1'b1 == ap_CS_fsm_state108)) begin
        x_0_i_i_i_i_reg_179 <= 13'd0;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state112)) begin
        y_0_i_i_i_i_reg_168 <= y_reg_306;
    end else if ((~((mul_ln821_loc_c31_full_n == 1'b0) | (mul_ln821_loc_c_empty_n == 1'b0) | (srcImgBuf0_V_offset_empty_n == 1'b0) | (ap_start == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        y_0_i_i_i_i_reg_168 <= 16'd0;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b1 == ap_CS_fsm_state2) & (icmp_ln24_fu_232_p2 == 1'd0))) begin
        add_ln33_reg_311 <= add_ln33_fu_247_p2;
    end
end

always @ (posedge ap_clk) begin
    if ((~((mul_ln821_loc_c31_full_n == 1'b0) | (mul_ln821_loc_c_empty_n == 1'b0) | (srcImgBuf0_V_offset_empty_n == 1'b0) | (ap_start == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        empty_reg_293[12 : 0] <= empty_fu_224_p1[12 : 0];
        trunc_ln_i_i_reg_283 <= {{add_ln29_fu_194_p2[16:4]}};
        zext_ln24_reg_298[27 : 0] <= zext_ln24_fu_228_p1[27 : 0];
        zext_ln37_reg_288[11 : 0] <= zext_ln37_fu_220_p1[11 : 0];
    end
end

always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln29_reg_322 == 1'd0))) begin
        fb_pix_V_reg_331 <= m_axi_srcImg_V_RDATA;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        icmp_ln29_reg_322 <= icmp_ln29_fu_262_p2;
        icmp_ln29_reg_322_pp0_iter1_reg <= icmp_ln29_reg_322;
    end
end

always @ (posedge ap_clk) begin
    if ((1'b1 == ap_CS_fsm_state2)) begin
        y_reg_306 <= y_fu_237_p2;
    end
end

always @ (*) begin
    if ((icmp_ln29_fu_262_p2 == 1'd1)) begin
...
always @ (*) begin
    if (((icmp_ln24_fu_232_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state2))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (icmp_ln29_reg_322_pp0_iter1_reg == 1'd0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter2 == 1'b1) & (icmp_ln29_reg_322_pp0_iter1_reg == 1'd0))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln29_reg_322 == 1'd0))) begin
...
always @ (*) begin
    if ((~((ap_start == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        mul_ln821_loc_c31_blk_n = mul_ln821_loc_c31_full_n;
    end else begin
        mul_ln821_loc_c31_blk_n = 1'b1;
    end
end

always @ (*) begin
    if ((~((mul_ln821_loc_c31_full_n == 1'b0) | (mul_ln821_loc_c_empty_n == 1'b0) | (srcImgBuf0_V_offset_empty_n == 1'b0) | (ap_start == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        mul_ln821_loc_c31_write = 1'b1;
    end else begin
        mul_ln821_loc_c31_write = 1'b0;
    end
end

always @ (*) begin
    if ((~((ap_start == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        mul_ln821_loc_c_blk_n = mul_ln821_loc_c_empty_n;
    end else begin
        mul_ln821_loc_c_blk_n = 1'b1;
    end
end

always @ (*) begin
    if ((~((mul_ln821_loc_c31_full_n == 1'b0) | (mul_ln821_loc_c_empty_n == 1'b0) | (srcImgBuf0_V_offset_empty_n == 1'b0) | (ap_start == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        mul_ln821_loc_c_read = 1'b1;
    end else begin
        mul_ln821_loc_c_read = 1'b0;
    end
end

always @ (*) begin
    if ((~((ap_start == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        srcImgBuf0_V_offset_blk_n = srcImgBuf0_V_offset_empty_n;
    end else begin
        srcImgBuf0_V_offset_blk_n = 1'b1;
    end
end

always @ (*) begin
    if ((~((mul_ln821_loc_c31_full_n == 1'b0) | (mul_ln821_loc_c_empty_n == 1'b0) | (srcImgBuf0_V_offset_empty_n == 1'b0) | (ap_start == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        srcImgBuf0_V_offset_read = 1'b1;
    end else begin
        srcImgBuf0_V_offset_read = 1'b0;
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (icmp_ln29_reg_322 == 1'd0))) begin
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if ((~((1'b0 == ap_block_pp0_stage0_subdone) & (icmp_ln29_fu_262_p2 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1)) & ~((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1)))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if ((((1'b0 == ap_block_pp0_stage0_subdone) & (icmp_ln29_fu_262_p2 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter0 == 1'b1)) | ((1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1)))) begin
...
assign add_ln29_fu_194_p2 = (zext_ln29_fu_190_p1 + 17'd15);

assign add_ln33_fu_247_p2 = (zext_ln24_reg_298 + zext_ln33_fu_243_p1);
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = (((img_plane0_V_V_full_n == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (icmp_ln29_reg_322_pp0_iter1_reg == 1'd0)) | ((m_axi_srcImg_V_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (icmp_ln29_reg_322 == 1'd0)));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = (((img_plane0_V_V_full_n == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (icmp_ln29_reg_322_pp0_iter1_reg == 1'd0)) | ((m_axi_srcImg_V_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (icmp_ln29_reg_322 == 1'd0)));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = (((img_plane0_V_V_full_n == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (icmp_ln29_reg_322_pp0_iter1_reg == 1'd0)) | ((m_axi_srcImg_V_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (icmp_ln29_reg_322 == 1'd0)));
end

always @ (*) begin
    ap_block_state1 = ((mul_ln821_loc_c31_full_n == 1'b0) | (mul_ln821_loc_c_empty_n == 1'b0) | (srcImgBuf0_V_offset_empty_n == 1'b0) | (ap_start == 1'b0) | (ap_done_reg == 1'b1));
end

assign ap_block_state109_pp0_stage0_iter0 = ~(1'b1 == 1'b1);

always @ (*) begin
    ap_block_state110_pp0_stage0_iter1 = ((m_axi_srcImg_V_RVALID == 1'b0) & (icmp_ln29_reg_322 == 1'd0));
end

always @ (*) begin
    ap_block_state111_pp0_stage0_iter2 = ((img_plane0_V_V_full_n == 1'b0) & (icmp_ln29_reg_322_pp0_iter1_reg == 1'd0));
end

assign ap_enable_pp0 = (ap_idle_pp0 ^ 1'b1);

assign empty_fu_224_p1 = trunc_ln_i_i_fu_200_p4;

assign icmp_ln24_fu_232_p2 = ((y_0_i_i_i_i_reg_168 == Height) ? 1'b1 : 1'b0);

assign icmp_ln29_fu_262_p2 = ((x_0_i_i_i_i_reg_179 == trunc_ln_i_i_reg_283) ? 1'b1 : 1'b0);

assign img_plane0_V_V_din = fb_pix_V_reg_331;

assign lshr_ln_i_i_fu_210_p4 = {{StrideInBytes[15:4]}};

assign m_axi_srcImg_V_ARADDR = zext_ln33_1_fu_252_p1;
...
assign m_axi_srcImg_V_ARLEN = empty_reg_293;
...
assign mul_ln821_loc_c31_din = mul_ln821_loc_c_dout;

assign offset_fu_273_p2 = (zext_ln37_reg_288 + offset_0_i_i_i_i_reg_156);

assign trunc_ln_i_i_fu_200_p4 = {{add_ln29_fu_194_p2[16:4]}};

assign x_fu_267_p2 = (x_0_i_i_i_i_reg_179 + 13'd1);

assign y_fu_237_p2 = (y_0_i_i_i_i_reg_168 + 16'd1);

assign zext_ln24_fu_228_p1 = srcImgBuf0_V_offset_dout;

assign zext_ln29_fu_190_p1 = mul_ln821_loc_c_dout;

assign zext_ln33_1_fu_252_p1 = add_ln33_reg_311;

assign zext_ln33_fu_243_p1 = offset_0_i_i_i_i_reg_156;

assign zext_ln37_fu_220_p1 = lshr_ln_i_i_fu_210_p4;

always @ (posedge ap_clk) begin
    zext_ln37_reg_288[27:12] <= 16'b0000000000000000;
    empty_reg_293[31:13] <= 19'b0000000000000000000;
    zext_ln24_reg_298[28] <= 1'b0;
end

endmodule //base_v_multi_scaler_0_2_AXIMMvideo2Bytes
