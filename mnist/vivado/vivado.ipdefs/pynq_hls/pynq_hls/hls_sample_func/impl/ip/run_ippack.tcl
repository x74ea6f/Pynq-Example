...
set IPName      "copy_mem"
set Version     "0.01"
set DisplayName "copy_mem"
set Revision    "2009161357"
set Description "copy axi mem"
set Device      "zynq"
set AutoFamily  ""
...
set sdx_kernel_name "copy_mem"
set sdx_kernel_type ""
set sdx_kernel_files {}
set enable_xo_gen 0
set sdaccel_dir [file join [pwd] .. kernel]
set solution_dir "C:/Vivado_Project/Pynq/test_mnist/pynq_hls/pynq_hls/hls_sample_func"
set debug_dir [file join $solution_dir .debug]
set xo_hls_files_dir ""
set hdl_module_list {copy_mem_AXILiteS_s_axi
...
set Interfaces {
    s_axi_AXILiteS {
        ...
        registers {{0x00 CTRL       RW   0x0 "Control signals" {{ 0 1 AP_START RW 0 "Control signal Register for 'ap_start'." } { 1 1 AP_DONE R 0 "Control signal Register for 'ap_done'." } { 2 1 AP_IDLE R 0 "Control signal Register for 'ap_idle'." } { 3 1 AP_READY R 0 "Control signal Register for 'ap_ready'." } { 4 3 RESERVED_1 R 0 "Reserved.  0s on read." } { 7 1 AUTO_RESTART RW 0 "Control signal Register for 'auto_restart'." } { 8 24 RESERVED_2 R 0 "Reserved.  0s on read." }}} {0x04 GIER       RW   0x0 "Global Interrupt Enable Register" {{ 0 1 Enable RW 0 "Master enable for the device interrupt output to the system interrupt controller: 0 = Disabled, 1 = Enabled" } { 1 31 RESERVED R 0 "Reserved.  0s on read." }} } {0x08 IP_IER     RW   0x0 "IP Interrupt Enable Register" {{ 0 1 CHAN0_INT_EN RW 0 "Enable Channel 0 (ap_done) Interrupt.  0 = Disabled, 1 = Enabled." } { 1 1 CHAN1_INT_EN RW 0 "Enable Channel 1 (ap_ready) Interrupt.  0 = Disabled, 1 = Enabled." } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x0c IP_ISR     RW   0x0 "IP Interrupt Status Register" {{ 0 1 CHAN0_INT_ST RTOW 0 "Channel 0 (ap_done) Interrupt Status. 0 = No Channel 0 input interrupt, 1 = Channel 0 input interrup" } { 1 1 CHAN1_INT_ST RTOW 0 "Channel 1 (ap_ready) Interrupt Status. 0 = No Channel 1 input interrupt, 1 = Channel 1 input interrup" } { 2 30 RESERVED R 0 "Reserved.  0s on read." }}} {0x10 inputBaseMemAdr_V W 0x0 "Data signal of inputBaseMemAdr_V" {{0 32 inputBaseMemAdr_V W 0 "Bit 31 to 0 Data signal of inputBaseMemAdr_V"}}} {0x18 outputBaseMemAdr_V W 0x0 "Data signal of outputBaseMemAdr_V" {{0 32 outputBaseMemAdr_V W 0 "Bit 31 to 0 Data signal of outputBaseMemAdr_V"}}} {0x20 loadSize_V W 0x0 "Data signal of loadSize_V" {{0 32 loadSize_V W 0 "Bit 31 to 0 Data signal of loadSize_V"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
    ...
    ap_clk {
        ...
        buses "s_axi_AXILiteS m_axi_extMemPtr_V"
        reset "ap_rst_n"
    }
    ap_rst_n {
        type "reset"
    ...
    m_axi_extMemPtr_V {
        type "native_axim"
        mode "master"
        port_prefix "m_axi_extMemPtr_V"
        data_width "32"
        param_prefix "C_M_AXI_EXTMEMPTR_V"
