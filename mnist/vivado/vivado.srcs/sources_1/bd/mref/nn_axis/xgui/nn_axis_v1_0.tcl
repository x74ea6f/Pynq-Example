...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "PARA" -parent ${Page_0}
...
proc update_PARAM_VALUE.PARA { PARAM_VALUE.PARA } {
	# Procedure called to update PARA when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.PARA { PARAM_VALUE.PARA } {
	# Procedure called to validate PARA
	return true
}


proc update_MODELPARAM_VALUE.PARA { MODELPARAM_VALUE.PARA PARAM_VALUE.PARA } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.PARA}] ${MODELPARAM_VALUE.PARA}
}
